...
export class MCPClient {
  ...
  constructor(config: MCPClientConfig) {
    ...
    this.client = new Client(
      { name: 'yyc3-AI-Family-mcp-client', version: '1.0.0' },
