...
import {
  ...
  Shield, ShoppingBag, Swords, Disc3, ArrowLeftRight, Upload, BookOpen,
} from 'lucide-react';
...
const FEATURE_CARDS = [
  ...
  },
  {
    ...
    iconFn: Upload,
    nameZh: '上传音乐/视频',
    nameEn: 'Upload Music/Video',
    descZh: '上传你的音频或视频文件',
    descEn: 'Upload your audio or video files',
    gradient: 'from-cyan-500/20 to-blue-500/20',
    borderColor: 'border-cyan-500/30',
    iconColor: 'text-cyan-400',
    action: 'onOpenUpload',
  },
  {
    id: 'design-guide',
    iconFn: BookOpen,
    nameZh: 'Figma AI 设计指南',
    nameEn: 'Figma AI Design Guide',
    descZh: '架构诊断 · 重构提示词 · UI规范',
    descEn: 'Audit · Refactoring Prompts · UI Spec',
    gradient: 'from-violet-500/20 to-pink-500/20',
    borderColor: 'border-violet-500/30',
    iconColor: 'text-violet-400',
    action: 'onOpenDesignGuide',
  },
] as const;
...
export const MobileDiscoverHub: React.FC<MobileDiscoverHubProps> = ({
  ...
  const actionMap: Record<string, () => void> = {
    ...
    onOpenDesignGuide: onOpenDesignGuide || (() => {}),
  };
